<?php
    ...
    class Authorize
    {
         ...
         * @return mixed
         */
        public static function authentication(string $appid, string $redirect_uri, string $response_type = 'code', string $scope = 'snsapi_base', $access_type = 'offline', string $state = '')
        {
